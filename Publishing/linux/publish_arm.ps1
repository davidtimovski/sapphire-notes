...
Copy-Item "C:\Users\david\source\repos\sapphire-notes\Src\SapphireNotes\bin\Release\net5.0\publish\SapphireNotes" -Destination "C:\Users\david\source\repos\sapphire-notes\Publishing\linux\output\sapphire-notes_${Version}_armhf\usr\bin\sapphire-notes"
